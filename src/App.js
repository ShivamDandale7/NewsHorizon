    ...
    return (
     ...
     <Videobackground/>
      ...
      <NavBar/>
         ...
         <Routes>
         <Route exact path="/" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="general"  country="us" category="general" headline={"General"}/>} />
         <Route exact path="/business" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="business"  country="us" category="business" headline={"Business"}/>} />
         <Route exact path="/entertainment" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="entertainment"  country="us" category="entertainment" headline={"Entertainment"}/>} />
         <Route exact path="/health" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="health"  country="us" category="health" headline={"Health"}/>} />
         <Route exact path="/science" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="science"  country="us" category="science" headline={"Science"}/>} />
         <Route exact path="/sports" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="sports"  country="us" category="sports" headline={"Sports"}/>} />
         <Route exact path="/technology" element={<News setProgress={setprogress} apiKey={apiKey} pageSize={pageSize} key="technology"  country="us" category="technology" headline={"Technology"}/>} />
         </Routes>
